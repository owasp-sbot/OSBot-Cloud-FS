...
class test_Cloud_FS__File__Info(TestCase):
    ...
    def test__init__(self):
        with Cloud_FS__File__Info() as _:
        ...
        kwargs =  dict(file_name    = Safe_Str__File__Name("file.json"),
                       ...
                       content      = Cloud_FS__File__Content(content_path='/abc'))
        with Cloud_FS__File__Info(**kwargs) as _:
            ...
            roundtrip = Cloud_FS__File__Info.from_json(json_data)
            ...
            assert type(roundtrip.content_type) is Cloud_FS__File__Content_Type
            assert type(roundtrip.content     ) is Cloud_FS__File__Content
